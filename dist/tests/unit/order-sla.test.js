...
const resolve_order_sla_1 = require("../../src/modules/orders-core/sla/resolve-order-sla");
describe("resolveOrderSlaSnapshot", () => {
    ...
    it("uses an explicit promise date before pricing SLA rules", async () => {
        ...
        const snapshot = await (0, resolve_order_sla_1.resolveOrderSlaSnapshot)({
            serviceType: client_1.ServiceType.DOOR_TO_DOOR,
            originQuery: "Beijing",
    ...
    it("prefers exact route SLA over zone and service default SLA", async () => {
        ...
        expect(snapshot.slaSource).toBe(client_1.OrderSlaSource.SLA_RULE);
