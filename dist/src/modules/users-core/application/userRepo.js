...
function safeUser(user) {
    ...
    return {
        ...
        driverType: rest.role === identity_access_1.ROLE_DRIVER
...
const registerUser = async (args) => {
    ...
    const role = args.role ?? identity_access_1.ROLE_CUSTOMER;
    // prevent duplicate
...
const createUserAsManager = async (args) => {
    ...
    return prismaClient_1.default.$transaction(async (tx) => {
        ...
        const isCustomer = args.role === identity_access_1.ROLE_CUSTOMER;
        ...
        if ((args.role === identity_access_1.ROLE_WAREHOUSE || args.role === identity_access_1.ROLE_DRIVER) &&
            args.warehouseId) {
        ...
        const createData = {
            ...
            password: hashedPassword,
            role: args.role,
            ...(args.role === identity_access_1.ROLE_DRIVER
                ? {
