...
async function getAnalyticsSummaryV2(params) {
    ...
    const result = await (0, analyticsReadModel_1.readThroughAnalyticsProjection)({
        section: "summary",
        key: readModelKey,
        ttlMs,
        buildFromDb: async () => {
...
async function getAnalyticsTrendV2(params) {
    ...
    return (0, analyticsReadModel_1.readThroughAnalyticsProjection)({
        section: "trend",
        key: readModelKey,
        ttlMs,
        buildFromDb: async () => {
